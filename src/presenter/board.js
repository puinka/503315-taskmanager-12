...
export default class Board {
  ...
  _handleLoadMoreButtonClick() {
    ...
    const newRenderTaskCount = Math.min(taskCount, this._renderedTaskCount + TASK_COUNT_PER_STEP);
    const tasks = this._getTasks().slice(this._renderedTaskCount, newRenderTaskCount);
  ...
  _clearBoard({resetRenderedTaskCount = false, resetSortType = false} = {}) {
    ...
    if (resetRenderedTaskCount) {
      ...
      this._renderTaksCount = Math.min(taskCount, this._renderedTaskCount);
    }
